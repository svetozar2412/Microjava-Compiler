...
public class MultipleOptionalDesignators extends DesignatorList {

    private DesignatorList DesignatorList;
    private OptionalDesignator OptionalDesignator;

    public MultipleOptionalDesignators (DesignatorList DesignatorList, OptionalDesignator OptionalDesignator) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MultipleOptionalDesignators(\n");
